...
function DeleteRestaurantDialog({ selectedRestaurant }) {
    ...
    return (
        <div>
            ...
            <button className="hover:bg-gray-100 text-sm text-gray-500 font-semibold px-3 py-1 rounded ml-4" onClick={handleOpen}>
                Delete Restaurant
            </button>
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                <p className="text-sm text-gray-400">Are you sure you want to delete the restaurant?</p>
